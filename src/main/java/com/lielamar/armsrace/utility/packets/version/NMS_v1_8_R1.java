...
public class NMS_v1_8_R1 implements PacketVersion {
    ...
    public void sendTitle(Player player, String title, String subtitle, int fadeIn, int fade, int fadeOut) {
        sendPacket(player, getTitlePacket(EnumTitleAction.TITLE, title, fadeIn, fade, fadeOut));
        sendPacket(player, getTitlePacket(EnumTitleAction.SUBTITLE, subtitle, fadeIn, fade, fadeOut));
    }
    ...
    private PacketPlayOutTitle getTitlePacket(EnumTitleAction titleAction, String text, int fadeIn, int fade, int fadeOut) {
