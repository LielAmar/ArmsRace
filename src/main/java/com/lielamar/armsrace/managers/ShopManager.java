...
import com.lielamar.armsrace.modules.shop.*;
...
public class ShopManager {
	...
	private CustomItem getItem(String shop, String id) {
		...
		XMaterial material = XMaterial.valueOf((String) config.get("shops." + shop + ".data." + id + ".material"));
		...
		ItemStack item = new ItemStack(material.parseMaterial(), quantity, material.getData());
