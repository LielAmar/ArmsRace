...
public class CustomItem {
	...
	public CustomItem(ItemType type, String name, ItemStack item, String action, List<SkillLevel> levels, String skillType, double price, String trailType, TrailData trailData, String killeffectType) {
		this.type = type;
		this.name = name;
		this.item = item;
