...
public class PlayerManager {
	...
	public PlayerManager(Main main) {
		...
		this.spawnProtection = new HashMap<UUID, Long>();
		this.doubleDamage = new ArrayList<UUID>();
		this.oneTap = new ArrayList<UUID>();
		this.swordlaunch = new HashMap<UUID, Long>();
		this.swordlaunchAs = new HashMap<UUID, ArmorStand>();
		
		this.players = new HashMap<UUID, CustomPlayer>();
	...
	public Long getSpawnProtection(Player p) {
		return (spawnProtection.containsKey(p.getUniqueId())?spawnProtection.get(p.getUniqueId()):-1);
	}
	...
	public Long getSwordLaunch(Player p) {
		return (swordlaunch.containsKey(p.getUniqueId())?swordlaunch.get(p.getUniqueId()):-1);
	}
