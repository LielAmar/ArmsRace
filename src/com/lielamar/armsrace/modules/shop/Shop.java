...
public class Shop {
	...
	public Shop(String name, boolean enabled, int rows) {
		...
		this.ci = new ArrayList<CustomItem>();
	}
	...
	/**
	 * @param cp      A {@link com.lielamar.armsrace.modules.CustomPlayer} object
	 * @return        A custom inventory for the given player
	 */
	public Inventory getCustomInventory(CustomPlayer cp) {
		Inventory copy = Bukkit.createInventory(null, inv.getSize(), inv.getTitle());
	 ...
	 * @return          A {@link com.lielamar.armsrace.modules.shop.CustomItem} object
	 */
